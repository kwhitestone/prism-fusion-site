...
// MetaMask avatar temporarily disabled - web3 packages removed for build performance
class AccountAvatar extends React.Component {
  render() {
    ...
    if (matchMetaMask) {
      // Fallback: render a colored circle based on address when MetaMask avatar is disabled
