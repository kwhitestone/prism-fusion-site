...
<div class="left-model">
  <span class="side-logo"> <img src="${Setting.StaticBaseUrl}/img/casdoor-logo_1185x256.png" alt="PrismAccount" style="width: 120px">
    <span>SSO</span>
  </span>
  <div class="img">
    <img src="${Setting.StaticBaseUrl}/img/casbin.svg" alt="PrismAccount"/>
  </div>
</div>
`;
...
class ApplicationEditPage extends React.Component {
  ...
  renderSignupSigninPreview() {
    ...
    const signInUrl = `/login/oauth/authorize?client_id=${clientId}&response_type=code&redirect_uri=${redirectUri}&scope=read&state=prismaccount`;
