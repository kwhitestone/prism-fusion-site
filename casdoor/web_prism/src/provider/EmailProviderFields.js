  ...
  return (
    <React.Fragment>
      ...
      <Row style={{marginTop: "20px"}} >
        ...
        <Col span={22} >
          <Row style={{marginTop: "20px"}} >
            <Button style={{marginLeft: "10px", marginBottom: "5px"}} onClick={() => updateProviderField("content", "You have requested a verification code at PrismAccount. Here is your code: %s, please enter in 5 minutes. <reset-link>Or click %link to reset</reset-link>")} >
      ...
      <Row style={{marginTop: "20px"}} >
        ...
        <Col span={22} >
          <Row style={{marginTop: "20px"}} >
            <Button style={{marginLeft: "10px", marginBottom: "5px"}} onClick={() => updateProviderField("metadata", "You have invited to join PrismAccount. Here is your invitation code: %s, please enter in 5 minutes. Or click %link to signup")} >
              {i18next.t("general:Reset to Default")} (Text)
            </Button>
