...
class SystemInfo extends React.Component {
  ...
  render() {
    ...
    const link = this.state.versionInfo?.version !== "" ? `https://github.com/PrismAccount/PrismAccount/releases/tag/${this.state.versionInfo?.version}` : "";
    ...
    if (!Setting.isMobile()) {
        ...
        <>
          <Row>
            ...
            <Col span={12}>
              ...
              <Divider />
              <Card id="about-card" title={i18next.t("system:About PrismAccount")} bordered={true} style={{textAlign: "center"}}>
                ...
                GitHub: <a target="_blank" rel="noreferrer" href="https://github.com/casdoor/casdoor">PrismAccount</a>
                <br />
                {i18next.t("system:Version")}: <a target="_blank" rel="noreferrer" href={link}>{versionText}</a>
                <br />
                {i18next.t("system:Official website")}: <a target="_blank" rel="noreferrer" href="https://whitestone.fun">https://whitestone.fun</a>
                <br />
                {i18next.t("system:Community")}: <a target="_blank" rel="noreferrer" href="https://whitestone.fun">Get in Touch!</a>
              </Card>
            </Col>
            <Col span={6}></Col>
          </Row>
      ...
      return (
        <Row gutter={[16, 0]}>
          ...
          <Col span={24}>
            <Card title={i18next.t("system:About PrismAccount")} bordered={true} style={{textAlign: "center"}}>
              <div>{i18next.t("system:An Identity and Access Management (IAM) / Single-Sign-On (SSO) platform with web UI supporting OAuth 2.0, OIDC, SAML and CAS")}</div>
              GitHub: <a target="_blank" rel="noreferrer" href="https://github.com/casdoor/casdoor">PrismAccount</a>
              <br />
              {i18next.t("system:Version")}: <a target="_blank" rel="noreferrer" href={link}>{versionText}</a>
