      ...
      <React.Fragment>
        ...
        <Footer id="footer" style={
          ...
          <div style={{fontSize: "12px", color: "#999"}}>
            <span>&copy; {new Date().getFullYear()} {Branding.BrandOrganization}. 保留所有权利。</span>
            <span style={{margin: "0 8px"}}>|</span>
            <a href={Branding.BeianIcpUrl} target="_blank" rel="noreferrer" style={{color: "#999"}}>
              {Branding.BeianIcp}
            </a>
            <span style={{margin: "0 8px"}}>|</span>
            <a href={Branding.BeianGonganUrl} target="_blank" rel="noreferrer" style={{color: "#999", display: "inline-flex", alignItems: "center", gap: "4px"}}>
              <img src="/img/beian.png" alt="" style={{width: "14px", height: "14px"}} />
              {Branding.BeianGongan}
            </a>
          </div>
        </Footer>
      </React.Fragment>
        ...
        title={
          <React.Fragment>
            <Tooltip title="Want to deploy your own AI assistant? Click to learn more!">
              <a target="_blank" rel="noreferrer" href={Branding.BrandHomepage}>
                <img style={{width: "20px", marginRight: "10px", marginBottom: "2px"}} alt="help" src={Branding.BrandLogo} />
                AI Assistant
              </a>
            </Tooltip>
    ...
    return (
      <Alert type="info" banner showIcon={false} closable message={
        <div style={{textAlign: "center"}}>
          ...
          &nbsp;
          <a target="_blank" rel="noreferrer" href={"https://crowdin.com/project/casdoor-site"}>{/* TODO: update crowdin link if needed */}
            Crowdin
          </a>
          &nbsp;!&nbsp;🙏
        </div>
    ...
    return (
      <React.Fragment>
        {(this.state.account === undefined || this.state.account === null) ?
          <Helmet>
            <link rel="icon" href={Branding.BrandFavicon} />
          </Helmet> :
          <Helmet>
